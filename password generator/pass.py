...
#title
heading = Label(root,text="Password Generator",font="areal 20")
...
def spin():
    ...
    def click():
            ...
            button1=Button(root,text="poor",font="areal 8",bg="red",fg="white",padx=15,pady=5,command=callback1)
            button1.place(x=80,y=255)
            button2=Button(root,text="moderate",font="areal 8",bg="red",fg="white",padx=15,pady=5,command=callback2)
            button2.place(x=150,y=255)
            button3=Button(root,text="Advanced",font="areal 8",bg="red",fg="white",padx=15,pady=5,command=callback3)
    ...
    button_=Button(root,text="Next",font="areal 8",bg="yellow",fg="red",command=click)
    button_.place(x=100,y=205)
    


#button
button=Button(root,text="Generate password:",font="Areal 12",bg="blue",fg="white",command=spin)
